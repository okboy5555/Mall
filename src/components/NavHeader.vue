    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          <span class="navbar-link" v-text="nickName" v-show="1"></span>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      // , {
      //   nickName: function (state) { //箭头函数会有this的问题
      //     let localData = window.localStorage.getItem('nickName');
      //     if (state.nickName === 0 && localData) {
      //       this.$store.commit('nickName', localData) //同步操作
      //     }
    ...
    methods: {
      init() {
        let localData = window.localStorage.getItem('nickName');
        this.$store.commit('nickName', localData);
      },
      nick() {
